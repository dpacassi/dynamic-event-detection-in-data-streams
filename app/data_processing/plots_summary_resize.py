...
def resize_image(image_file, new_image_file, fix=False):
...
resize_image("../../doc/images/summary/hdbscan_kmeans_de.png", "../../doc/images/summary/cropped_hdbscan_kmeans_de.png", True)
resize_image("../../doc/images/summary/hdbscan_kmeans_en.png", "../../doc/images/summary/cropped_hdbscan_kmeans_en.png", True)
