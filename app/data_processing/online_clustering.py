...
if __name__ == "__main__":
    ...
    ap.add_argument("--rows", required=False, type=str, default=None, help="numbers of samples to process per batch")
    ap.add_argument("--hours", required=False, type=str, default=None, help="numbers of hours to load samples")
    ap.add_argument("--factors", required=False, type=str, default=None, help="factor to use for relative batch sizes")
