...
Using \textit{Text Stemming} or \textit{Text Lemmatization}, we can simplify terms and group them together to reduce
the dictionary size.
We will cover both practices in the subsections~\ref{subsubsec:3_keyphrase_extraction} and \ref{subsubsec:3_named_entity_recognition}.
