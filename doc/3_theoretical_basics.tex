...
\label{subsec:text_preprocessing}
...
the dictionary size.
We will cover both practices in the subsections~\ref{subsec:keyphrase_extraction} and \ref{subsec:named_entity_recognition}.
...
\label{subsec:named_entity_recognition}
...
\label{subsec:text_lemmatization}
...
\label{subsec:vector_space_model}
...
\label{subsec:term_frequency}

The easiest vectoriser is the Term Frequency Vectorizer.
...
\label{subsec:kmeans_clustering}
...
The dendogram in Figure \ref{fig:hdbscan_2} shows a possible cluster hierarchy. %TODO rewrite this paragraph.
