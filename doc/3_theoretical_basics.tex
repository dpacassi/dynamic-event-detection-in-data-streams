...
The algorithm simply follows 5 steps with replacement and/or removal rules and is therefore very easy and efficient.
...
If we now want to compare two documents with each other,
...
therefore the significance of one term is weighted heavier in document \textit{d2}.
