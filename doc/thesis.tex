...
\newcommand\equname{Equation}
\newcommand\lstname{Listing}

\newcommand*{\tabref}[1]{\tablename~\ref{#1}}
\newcommand*{\figref}[1]{\figurename~\ref{#1}}
\newcommand*{\equref}[1]{\equname~\ref{#1}}
\newcommand*{\lstref}[1]{\lstname~\ref{#1}}
\newcommand*{\secref}[1]{\secname~\ref{#1}}
\newcommand*{\subsecref}[1]{\subsecname~\ref{#1}}
\newcommand*{\subsubsecref}[1]{\subsubsecname~\ref{#1}}
...
\include{4_design_and_implementation}
\include{5_results}
