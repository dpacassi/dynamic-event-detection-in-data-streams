...
We look at five different preprocessing methods as described in \subsecref{subsec:3_text_preprocessing}
and evaluate each.
The methods are:
...
As we can see in \tabref{tab:preprocessing_times}, Text Stemming is by far the fastest method of the above mentioned
