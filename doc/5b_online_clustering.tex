...
Figure \ref{fig:event_detection_differences_hours} shows the difference in detected events compared with the true number of events using the second dynamic  method. Similar 
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|r|r|r|r|r|r|}
        ...
        \hline
        Fixed with n=3000 & 0.701 & 0.085 & 0.542 & 0.435 & 0.683 & 0.144\\ \hline
        Time based with hours=24 & 0.717 & 0.119 & 0.618 & 0.426 & 0.694 & 0.16 \\ \hline
        Relative with factor=25 & 0.688 & 0.091 & 0.589 & 0.427 & 0.677 & 0.135 \\ \hline
    \end{tabular}
    }
